   ...
   // ----------------------------------------------------------
    ...
    static int countCollinear(int[] a1, int[] a2, int[] a3)
    {
      //TODO: implement this method
    	...
    	int N=1000;
    	int numberOfCollinears=0;
    	
    	for(int a1Index=0; a1Index<N; a1Index++)
    	{
    		for(int a2Index=0; a2Index<N; a2Index++)
    		{
    			for(int a3Index=0; a3Index<N; a3Index++)
    			{
    				if( (a1[a1Index] * (y2 - y3)) + (a2[a2Index] * (y3-y1)) + (a3[a3Index] * (y1-y2)) ==0)
    					numberOfCollinears++;
    			}
    		}
    	}
    	return numberOfCollinears;
    }
